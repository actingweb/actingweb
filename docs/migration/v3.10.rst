...
No migration changes needed. The endpoint returns either custom permission overrides
or trust type defaults, allowing peers to discover what permissions they have been granted.
