...
from actingweb.trust_type_registry import TrustType, get_registry, TRUST_TYPE_SYSTEM_ACTOR
...
class TestTrustRegistryIntegration(unittest.TestCase):
    ...
    def test_register_custom_type(self):
        ...
        self.assertEqual(retrieved.display_name, "Custom Test Type")
        self.assertEqual(retrieved.oauth_scope, "actingweb.custom_test")
    ...
    def test_registry_persistence(self):
        ...
        self.assertIsNotNone(retrieved)
        self.assertEqual(retrieved.name, "persistence_test")
        self.assertEqual(retrieved.description, "Testing persistence")
